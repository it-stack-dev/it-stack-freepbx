# Lab 10-06 — Production Deployment

**Module:** 10 — FreePBX/Asterisk VoIP PBX  
**Duration:** See [lab manual](https://github.com/it-stack-dev/it-stack-docs)  
**Test Script:** 	ests/labs/test-lab-10-06.sh  
**Compose File:** docker/docker-compose.production.yml

## Objective

Deploy freepbx in production with HA, monitoring, backup, and DR.

## Prerequisites

- Labs 10-01 through 10-05 pass
